#ifndef PN532_IIC_H_INCLUDE
#define PN532_IIC_H_INCLUDE
...
//全局变量
extern unsigned char REG_data_Buff[50];

//函数接口
extern void Single_WritePN532_v2(unsigned char REG_Address,unsigned char REG_data);
extern unsigned char Single_ReadPN532_v2(void);
extern void PN532_Active(void);
extern unsigned char Mul_ReadPN532_v2(void);
extern void Write_Cmd(u8 *cmd, u8 len);
extern void Read_Data(u8 *buf, u8 len);
