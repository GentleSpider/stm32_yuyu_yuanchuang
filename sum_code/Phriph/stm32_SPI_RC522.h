...
#ifndef STM32_SPI_RC522_H_INCLUDE
#define	STM32_SPI_RC522_H_INCLUDE
#include <stm32f10x.h>
/////////////////////////////////////////////////////////////////////
//MF522命令字
/////////////////////////////////////////////////////////////////////
...
extern void WriteRawRC(u8   Address, u8   value);
extern void SetBitMask(u8   reg,u8   mask);
extern char PcdComMF522(u8   Command, 
                 u8 *pIn , 
                 u8   InLenByte,
                 u8 *pOut , 
                 u8  *pOutLenBit);
extern void CalulateCRC(u8 *pIn ,u8   len,u8 *pOut );
extern u8 ReadRawRC(u8   Address);
